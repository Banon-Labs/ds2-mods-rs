...
CASES = [
    ...
    Case(
        ...
        "DS2-MODS-NO-DEFERRED-EVIDENCE-READ rather than DS2-MODS-NO-PROMISSORY-CLOSER",
    ),
    Case(
    ...
    Case(
        ...
        "'the guard refused the write' and DS2-MODS-NO-BLAME-DEFLECTION halted it correctly, "
    ...
    Case(
        ...
        "narrating the action instead of having taken it",
        "'Rebuilding and relaunching now.' -- the one spelling DS2-MODS-NO-ZERO-INFORMATION-STOP "
