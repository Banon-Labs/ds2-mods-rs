...
PROJECT_DIR = "/fake/project/ds2-mods-rs"
...
def main() -> int:
    ...
    expect(
        ...
        [
            ...
            assistant_bash("python3 scripts/ds2-run.py"),
        ],
        silent,
    ...
    expect(
        ...
        [
            user("Launch it."),
            assistant_text_then_bash("I'll launch it now.", "python3 scripts/ds2-run.py"),
        ],
        silent,
    ...
    expect(
        ...
        [
            user("Build it."),
            assistant_bash("bash scripts/check.sh", "toolu_bg", background=True),
    ...
    expect(
        ...
        [
            ...
            assistant_bash("nohup tail -F target/ds2-run.log > target/watch.log 2>&1 &"),
    ...
    expect(
        ...
        [
            ...
            assistant_bash("python3 scripts/ds2-run.py", "toolu_bg", background=True),
            background_launch_result("toolu_bg"),
    ...
    expect(
        ...
        [
            user("Build it."),
            assistant_bash("bash scripts/check.sh", "toolu_bg", background=False),
            assistant_text("I'll read the build log the moment it lands."),
        ],
        fires,
    ...
    expect(
        ...
        [
            user("Start the watcher."),
            assistant_bash("tail -F target/ds2-run.log"),
            assistant_text("I'll read the watcher output as soon as the semaphore asserts."),
        ],
        fires,
