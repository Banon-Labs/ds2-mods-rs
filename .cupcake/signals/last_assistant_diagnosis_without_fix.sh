...
#   * `DS2-MODS-NO-DESCRIBED-NEXT-STEP` requires a forward-looking prescription ("the next step
...
#     straight through.
#   * `DS2-MODS-NO-IDLE-HOLD` wants an announcement of waiting. Such a turn announces nothing; it
#     just ends.
#   * `DS2-MODS-NO-STALL-ON-FRICTION` needs the opening prompt to carry frustration, and its
