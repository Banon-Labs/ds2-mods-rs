...
commitment := "DS2-MODS-NO-FUTURE-TENSE-COMMITMENT"

delegation := "DS2-MODS-NO-DELEGATION-AS-COMPLETION"
...
# The first shape belongs to DS2-MODS-NO-ZERO-INFORMATION-STOP, not here; the second is not due.
