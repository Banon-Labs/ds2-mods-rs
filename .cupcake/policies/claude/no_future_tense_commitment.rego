...
# custom:
#   severity: HIGH
#   id: DS2-MODS-NO-FUTURE-TENSE-COMMITMENT
#   description: >-
...
#       * DS2-MODS-NO-UNEXECUTED-PROMISE finds the promise and then exempts it twice over. Its
...
#       * DS2-MODS-NO-ZERO-INFORMATION-STOP did produce a handback fact for it and exempted on the
...
#                      belongs to DS2-MODS-NO-ZERO-INFORMATION-STOP, which convicts an offer to do
...
#                      these two shapes.
#
#     DS2-MODS-NO-DELEGATION-AS-COMPLETION is the second rule in this package: the same defect with
...
halt contains decision if {
	...
	decision := {
		"rule_id": "DS2-MODS-NO-FUTURE-TENSE-COMMITMENT",
...
halt contains decision if {
	...
	decision := {
		"rule_id": "DS2-MODS-NO-DELEGATION-AS-COMPLETION",
