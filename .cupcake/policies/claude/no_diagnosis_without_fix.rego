...
# custom:
#   severity: HIGH
#   id: DS2-MODS-NO-DIAGNOSIS-WITHOUT-FIX
#   description: >-
...
#
#     Why a new rule rather than widening a neighbour: DS2-MODS-NO-DESCRIBED-NEXT-STEP excludes a
#     bare "the fix is X" on purpose (it is how a completed fix gets reported), DS2-MODS-NO-IDLE-
#     HOLD needs an announcement of waiting, and DS2-MODS-NO-STALL-ON-FRICTION requires the prompt
...
#
#     DS2-MODS-NO-PROMISSORY-CLOSER (added 2026-09-09) is the second rule in this package, and it
...
#     walked past every Stop guard in the repo: DS2-MODS-NO-UNEXECUTED-PROMISE needs a
#     first-person opener ("I'll", "I'm going to", "let me") and this sentence commits nobody, while
#     DS2-MODS-NO-DESCRIBED-NEXT-STEP needs a forward-looking prescription and "Fixing" points at
...
#
#     DS2-MODS-NO-ZERO-INFORMATION-STOP (added 2026-09-09) is the third rule here, from the user
...
#     DS2-MODS-NO-UNEXECUTED-PROMISE and DS2-MODS-NO-DESCRIBED-NEXT-STEP both exempt a turn that
...
#
#     DS2-MODS-NO-DEFERRED-INVESTIGATION (added 2026-09-12) is the fourth rule here, and it is the
...
#     holds the answer. DS2-MODS-NO-DESCRIBED-NEXT-STEP is the nearest neighbour and misses on both
...
halt contains decision if {
	...
	decision := {
		"rule_id": "DS2-MODS-NO-DIAGNOSIS-WITHOUT-FIX",
...
halt contains decision if {
	...
	decision := {
		"rule_id": "DS2-MODS-NO-PROMISSORY-CLOSER",
...
halt contains decision if {
	...
	decision := {
		"rule_id": "DS2-MODS-NO-ZERO-INFORMATION-STOP",
...
halt contains decision if {
	...
	decision := {
		"rule_id": "DS2-MODS-NO-DEFERRED-INVESTIGATION",
