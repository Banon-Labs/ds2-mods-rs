...
# custom:
#   severity: HIGH
#   id: DS2-MODS-NO-ADMISSION-WITH-DEFENCE
#   description: >-
...
#       * DS2-MODS-NO-STALL-ON-FRICTION reads a different admission family: contrition about being
...
#       * DS2-MODS-NO-EXPLANATION-INSTEAD-OF-CORRECTION needs a second-person challenge in the
...
#       * DS2-MODS-NO-DIAGNOSIS-WITHOUT-FIX needs the reply to name a defect. This reply says the
#         mechanism is fine.
#       * DS2-MODS-NO-NARRATED-ACTION and DS2-MODS-NO-FUTURE-TENSE-COMMITMENT both need the
...
#                    rule stays out of it, the same stance DS2-MODS-NO-EXPLANATION-INSTEAD-OF-
...
halt contains decision if {
	...
	decision := {
		"rule_id": "DS2-MODS-NO-ADMISSION-WITH-DEFENCE",
