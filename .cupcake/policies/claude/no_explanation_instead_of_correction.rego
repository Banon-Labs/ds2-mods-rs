...
# custom:
#   severity: HIGH
#   id: DS2-MODS-NO-EXPLANATION-INSTEAD-OF-CORRECTION
#   description: >-
...
#       * DS2-MODS-NO-STALL-ON-FRICTION exempts any turn whose opening prompt asked a question,
...
#       * DS2-MODS-NO-DIAGNOSIS-WITHOUT-FIX needs the reply to name a defect. A defence of a
#         convention names none -- it says the convention is fine.
#       * DS2-MODS-NO-FUTURE-TENSE-COMMITMENT needs a first-person future promise of a class the
...
#
#     DS2-MODS-NO-CONCESSION-PIVOT is the second rule in this package: the em-dash pivot the user
...
halt contains decision if {
	...
	decision := {
		"rule_id": "DS2-MODS-NO-EXPLANATION-INSTEAD-OF-CORRECTION",
...
halt contains decision if {
	...
	decision := {
		"rule_id": "DS2-MODS-NO-CONCESSION-PIVOT",
