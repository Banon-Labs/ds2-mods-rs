...
# custom:
#   severity: HIGH
#   id: DS2-MODS-REQUIRE-FRESH-ORIGIN-MAIN
#   routing:
...
deny contains decision if {
    ...
    guarded(lower(text))
    not fresh
    decision := {"rule_id": "DS2-MODS-REQUIRE-FRESH-ORIGIN-MAIN", "reason": "origin/main is stale or could not be verified against origin. Run `git fetch origin main`, then retry the rebase or force-push.", "severity": "HIGH"}
}
