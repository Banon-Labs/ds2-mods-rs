...
# custom:
#   severity: HIGH
#   id: DS2-MODS-NO-PROOF-WITHOUT-OBSERVATION
#   description: >-
...
#
#     Why a new rule rather than widening a neighbour: DS2-MODS-NO-UNBACKED-CLAIM asks whether a
#     repo artifact the turn claims to have built exists, which a proof claim about the game never
#     touches; DS2-MODS-NO-FALSE-CI-GREEN is about a gate's own result. This one turns on the
...
halt contains decision if {
	...
	decision := {
		"rule_id": "DS2-MODS-NO-PROOF-WITHOUT-OBSERVATION",
