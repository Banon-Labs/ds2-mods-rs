...
# custom:
#   severity: HIGH
#   id: DS2-MODS-NO-MERGEABLE-WITHOUT-GREEN-CI
#   description: >-
#     PORTED from er-mods-rs on 2026-09-25, rule and reason text unchanged. PROVENANCE.md
#     left it behind on 2026-09-21 because this repo had no CI to be green; it has one now,
#     .github/workflows/release.yml, which builds the shipped DLLs on every pull request. The
#     er signal was inert (it called a property as a function and swallowed the TypeError);
#     the ds2 signal reads the closing prose correctly and is driven end to end by
#     .cupcake/tests/fixtures/mergeable_claim*.jsonl. The history below is er-mods-rs's.
#
...
halt contains decision if {
	...
	not claim.green
	decision := {
		"rule_id": "DS2-MODS-NO-MERGEABLE-WITHOUT-GREEN-CI",
