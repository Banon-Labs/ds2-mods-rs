...
# custom:
#   severity: HIGH
#   id: DS2-MODS-NO-STALL-ON-FRICTION
#   description: >-
...
#       * DS2-MODS-NO-STALL-ON-FRICTION -- friction + an admission/retraction/concession-closure in
...
#       * DS2-MODS-NO-DECISION-HANDBACK -- friction + the turn ends by handing the DECISION back
...
#         excuse it.
#       * DS2-MODS-NO-BLAME-DEFLECTION (added 2026-08-04) -- the turn attributes a consequence to a
...
halt contains decision if {
	...
	stalled
	decision := {
		"rule_id": "DS2-MODS-NO-STALL-ON-FRICTION",
		"reason": stall_reason,
		"severity": "HIGH",
	}
}
...
halt contains decision if {
	...
	handed_back
	decision := {
		"rule_id": "DS2-MODS-NO-DECISION-HANDBACK",
...
halt contains decision if {
	...
	deflected
	decision := {
		"rule_id": "DS2-MODS-NO-BLAME-DEFLECTION",
		"reason": blame_reason,
		"severity": "HIGH",
	}
}
