...
# custom:
#   severity: HIGH
#   id: DS2-MODS-NO-DEFERRED-EVIDENCE-READ
#   description: >-
...
#
#     Why the neighbours miss it. DS2-MODS-NO-UNEXECUTED-PROMISE keys on a first-person intention
#     verb, DS2-MODS-NO-DESCRIBED-NEXT-STEP on a forward-looking prescription whose noun comes from
#     a fixed list that does not carry the word measurement, and DS2-MODS-NO-DIAGNOSIS-WITHOUT-FIX on a
...
#     under DS2-MODS-NO-PROMISSORY-CLOSER. That arm convicts the verbatim sentence above and keeps
...
halt contains decision if {
	...
	decision := {
		"rule_id": "DS2-MODS-NO-DEFERRED-EVIDENCE-READ",
...
# `DS2-MODS-NO-PROMISSORY-CLOSER` owns the deferrals its own signal recognises, and a turn must
