...
# custom:
#   severity: HIGH
#   id: DS2-MODS-NO-NARRATED-ACTION
#   description: >-
...
#     never worth reading'".
#
#     This is the present-progressive sibling of DS2-MODS-NO-FUTURE-TENSE-COMMITMENT, and the gap
...
#       * DS2-MODS-NO-PROMISSORY-CLOSER does convict a subjectless gerund, but only from the
...
#       * DS2-MODS-NO-ZERO-INFORMATION-STOP reaches the build/launch/run family end-anchored on
...
#       * DS2-MODS-NO-DESCRIBED-NEXT-STEP needs an impersonal prescription ("the next step is").
#         The present participle points at now, not next.
#       * DS2-MODS-NO-UNEXECUTED-PROMISE needs a first-person opener.
#
...
#         need from you is ...") is not caught here. It is DS2-MODS-NO-ZERO-INFORMATION-STOP's
...
#         matches this rule and also DS2-MODS-NO-ZERO-INFORMATION-STOP's own launch-family
...
#       * DS2-MODS-NO-ZERO-INFORMATION-STOP has no banner exemption of its own, so a mandated
...
halt contains decision if {
	...
	decision := {
		"rule_id": "DS2-MODS-NO-NARRATED-ACTION",
