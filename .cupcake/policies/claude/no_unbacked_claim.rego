...
#
#     SIBLING of DS2-MODS-NO-UNEXECUTED-PROMISE, covering the opposite tense. That guard catches
...
halt contains decision if {
	...
	some p in [phrase]
	decision := {
		"rule_id": "DS2-MODS-NO-UNBACKED-CLAIM",
		"reason": reason_for(p),
		"severity": "HIGH",
	}
}
